@extends('layouts.app')
@section('title')
<title>Laporan Peminjaman - Sarana & Inventaris</title>
@endsection
@section('content')
    <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ url('/laporan-peminjaman/') }}" method="GET">
                                @csrf                
                        ...
                        <table class="masterDataTables table display table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $item->pegawai->nama_pegawai }} Meminjam Inventaris 
...
<script>
        $('.masterDataTables').DataTable({
            ...
            [5, 10, 15, 20, -1],
                    ...
                    "buttons": [
                    { extend: 'print', className: 'btn btn-lg bg-dark text-white',title: 'Laporan Peminjaman Inventaris', },
                    { extend: 'pdf', className: 'btn btn-lg bg-danger text-white', title: 'Laporan Peminjaman Inventaris', customize: function (doc) {doc.content[1].table.widths = Array(doc.content[1].table.body[0].length + 1).join('*').split(''); } },
                    { extend: 'csv', className: 'btn btn-lg bg-primary text-white ', title: 'Laporan Peminjaman Inventaris'},
                    { extend: 'excel', className: 'btn btn-lg bg-success text-white ', title: 'Laporan Peminjaman Inventaris'},
                    ],
